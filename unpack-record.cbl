       ...
       01  W-KEY-FIELD.
           05  W-LINK      PIC X(4) COMP-X.
           05  W-KEY-LEN   PIC X COMP-X.
           05  W-KEY       PIC X(20).
       ...
       01  L-TABLE.
           05  L-LEAF      PIC X.
           05  L-LENGTH    PIC 99 COMP.
           05  L-KEY       PIC X(30) OCCURS 84 TIMES.
           05  L-LINK      PIC X(4) COMP-X OCCURS 85 TIMES.
       ...
       PROCESS-PREFIX.
           IF L-PREFIX >= 32768 THEN
               MOVE 'Y' TO L-LEAF
               SUBTRACT 32768 FROM L-PREFIX GIVING W-REC-LEN
           ELSE
               MOVE 'N' TO L-LEAF
